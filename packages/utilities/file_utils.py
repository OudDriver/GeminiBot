...
def save_temp_config(
    ...
    Args:
        ...
        thought: The thought generated by non-thinking models.
                 May NOT be deprecated if Google decided to include thinking
                 to all models because I still have to store the thoughts somehow.
        secret: The secret to keep.
        tool_use: The tool use to append.
        thinking: Whether for new models (such as Gemini 2.5 Flash)
                  to think or not.
